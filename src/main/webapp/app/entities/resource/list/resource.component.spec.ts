...
describe('Resource Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '68629277-5060-42bd-8ce0-72257336c171' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '2c769352-41ba-42c3-909c-d7b655ed460c' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.resources()[0]).toEqual(expect.objectContaining({ id: '68629277-5060-42bd-8ce0-72257336c171' }));
  });
