...
export class ResourceComponent implements OnInit {
  private static readonly NOT_SORTABLE_FIELDS_AFTER_SEARCH = ['id', 'resourceId', 'name', 'resourceType', 'location'];
  ...
  trackId = (item: IResource): string => this.resourceService.getResourceIdentifier(item);
