...
describe('Assignment Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'df3db523-0385-470a-ba04-20bdc44f4230' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'd27db878-0c1f-476e-b487-30ebce9de070' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.assignments()[0]).toEqual(expect.objectContaining({ id: 'df3db523-0385-470a-ba04-20bdc44f4230' }));
  });

  describe('trackId', () => {
    it('Should forward to assignmentService', () => {
      const entity = { id: 'df3db523-0385-470a-ba04-20bdc44f4230' };
