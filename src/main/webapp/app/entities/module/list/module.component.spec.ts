...
describe('Module Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '45d29272-e86d-4bcf-b095-4af54a23f61c' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0f2773b6-3afb-40d6-a011-518e1674f28a' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.modules()[0]).toEqual(expect.objectContaining({ id: '45d29272-e86d-4bcf-b095-4af54a23f61c' }));
  });

  describe('trackId', () => {
    it('Should forward to moduleService', () => {
      const entity = { id: '45d29272-e86d-4bcf-b095-4af54a23f61c' };
