...
describe('Course Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '111fabe5-d417-4bae-ac6e-f3e3a988982f' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '85e942c3-e3e8-4da2-bd51-1e7f78f98fe6' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.courses()[0]).toEqual(expect.objectContaining({ id: '111fabe5-d417-4bae-ac6e-f3e3a988982f' }));
  });
