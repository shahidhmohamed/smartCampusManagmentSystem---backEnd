package com.smartcampusmanagmentsystem.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.smartcampusmanagmentsystem.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.smartcampusmanagmentsystem.security.DomainUserDetailsService", "createSpringSecurityUser");
